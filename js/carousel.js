function createServiceCards() {
    ...
    services.forEach(service => {
        ...
        slideDiv.className = 'carousel-slide min-w-full flex justify-center py-12 px-8 bg-white/95 backdrop-blur-md';
        slideDiv.innerHTML = `
            <div class="bg-white p-12 py-16 px-16 shadow-lg rounded-xl border border-gray-light text-center transition hover:-translate-y-2 min-h-[500px] max-w-[600px]">
                ...
                <h4 class="mt-6 text-xl font-bold text-dark">${service.titulo}</h4>
                <div class="mt-4 text-justify text-lg leading-8 text-gray-600">
